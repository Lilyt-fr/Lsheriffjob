...
function OpenGetWeaponMenu()
	...
	ESX.TriggerServerCallback('finalsheriff:getArmoryWeapons', function(weapons)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory_get_weapon',
		{
			...
			ESX.TriggerServerCallback('finalsheriff:removeArmoryWeapon', function()
			OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory_put_weapon',
	{
		...
		ESX.TriggerServerCallback('finalsheriff:addArmoryWeapon', function()
			OpenPutWeaponMenu()
...
function OpenVehicleInfosMenu(vehicleData)
	ESX.TriggerServerCallback('finalsheriff:getVehicleInfos', function(retrivedInfo)
